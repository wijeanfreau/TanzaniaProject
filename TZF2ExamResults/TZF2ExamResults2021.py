...
baselink = 'https://maktaba.tetea.org/exam-results/FTNA2021/ftna.htm'
masterlist = []
year = str(2021)
...
with open('V:/FHSS-JoePriceResearch/RA_work_folders/Winthrop_Jeanfreau/TanzaniaProject/TanzaniaCSVs/TZF2ExamResults2021Raw.csv', 'w') as work_file:
