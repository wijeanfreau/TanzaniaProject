...
baselink = 'https://maktaba.tetea.org/exam-results/FTNA2020/ftna.htm'
masterlist = []
year = str(2020)
...
with open('V:/FHSS-JoePriceResearch/RA_work_folders/Winthrop_Jeanfreau/TanzaniaProject/TanzaniaCSVs/TZF2ExamResults2020Raw.csv', 'w') as work_file:
