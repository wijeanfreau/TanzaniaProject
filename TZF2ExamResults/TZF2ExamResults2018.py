...
baselink = 'https://maktaba.tetea.org/exam-results/FTNA2018/ftna.htm'
masterlist = []
year = str(2018)
...
with open('V:/FHSS-JoePriceResearch/RA_work_folders/Winthrop_Jeanfreau/TanzaniaProject/TanzaniaCSVs/TZF2ExamResults2018Raw.csv', 'w') as work_file:
