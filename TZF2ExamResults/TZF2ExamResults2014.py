...
baselink = 'https://maktaba.tetea.org/exam-results/FTSEE2014-2/formtwo-2014-2.htm'
masterlist = []
year = str(2014)
...
with sync_playwright() as pw:
    ...
    print('Finished scraping and appending master list!')   
    page.close()
    context.close()
    browser.close()
    
with open('V:/FHSS-JoePriceResearch/RA_work_folders/Winthrop_Jeanfreau/TanzaniaProject/TanzaniaCSVs/TZF2ExamResults2014Raw.csv', 'w') as work_file:
