...
baselink = 'https://maktaba.tetea.org/exam-results/FTNA2017/ftna.htm'
masterlist = []
year = str(2017)
...
with open('V:/FHSS-JoePriceResearch/RA_work_folders/Winthrop_Jeanfreau/TanzaniaProject/TanzaniaCSVs/TZF2ExamResults2017Raw.csv', 'w') as work_file:
