...
baselink = 'https://web.archive.org/web/20171213105612/https://www.tamisemi.go.tz/form_five_selection_or/second'
masterlist = []
...
with sync_playwright() as my_playwright:
    ...
    for i in range(0,total):
        ...
        try:
            ...
            page.goto(f'https://web.archive.org/web/20171213105612/https://www.tamisemi.go.tz/form_five_selection_or/second/?page={nextscreen}')
            continue
    page.close()
    context.close()
    my_chrome.close()
    
with open('V:/FHSS-JoePriceResearch/RA_work_folders/Winthrop_Jeanfreau/TanzaniaProject/TanzaniaCSVs/TZ2017F5AdmitsS2.csv', 'w') as work_file:
